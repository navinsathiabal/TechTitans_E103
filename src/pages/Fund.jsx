    ...
    return (
        <div className="page-container">
            ...
            <div className="animate-enter">
                {activeTab === 'fund' ? (
                    <div className="fund-grid centered-layout">
                                ...
                                {gigs.map(g => (
                                    <div key={g.id} className="glass-panel listing-card" onClick={() => setSelectedItem(g)}>
                                        ...
                                        <div className="card-stats">
                                            ...
                                            <button className="btn-outline sm">Apply</button>
                                        </div>
                                    </div>
                                ))}
                            </div>
                    ...
                    <div className="modal-content glass-panel" onClick={e => e.stopPropagation()}>
                        ...
                        <div className="modal-body">
                            ...
                            <button className="btn-primary full-width mt-4">
                                {selectedItem.name ? `Contact ${selectedItem.name.split(' ')[0]}` : "Apply for Project"} <ArrowRight size={16} />
                            </button>
                        </div>
                    </div>
                </div>
